...
This document outlines the security and lifecycle policies for the LlanSacco API.
...
The LlanSacco solution uses a decoupled architecture where the Blazor Web App and MAUI clients act as pure HTTP clients consuming the API. 
