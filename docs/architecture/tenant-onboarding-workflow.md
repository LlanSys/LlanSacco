...
This document outlines the end-to-end operational workflows for onboarding new tenants to the LlanSacco SaaS platform. Because the platform supports both **Pooled** and **Isolated** isolation tiers, the onboarding steps vary based on the level of isolation required by the client.
...
2. **Register the Tenant (Control Panel):**
   - An administrator logs into the LlanSacco Control Panel.
