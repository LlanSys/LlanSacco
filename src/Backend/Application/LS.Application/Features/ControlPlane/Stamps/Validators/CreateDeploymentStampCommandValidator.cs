...
namespace LS.Application.Features.ControlPlane.Stamps.Validators;

internal class CreateDeploymentStampCommandValidator : AbstractValidator<CreateDeploymentStampCommand>
{
