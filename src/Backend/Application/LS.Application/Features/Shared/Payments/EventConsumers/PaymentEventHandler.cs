using LS.Domain.Features.Shared.Payments.Events;
using MediatR;
using Microsoft.Extensions.Logging;
using LS.Application.Utilities;

namespace LS.Application.Features.Shared.Payments.EventConsumers;

internal sealed class PaymentEventHandler(ILogger<PaymentEventHandler> logger) :
