    ...
    : IRequestHandler<GetPaymentHistoryQuery, AppResponse<PagedResponse<PaymentHistoryItemResponse, Guid>>>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        Expression<Func<LS.Domain.Features.Shared.Payments.Entities.PaymentRecord, bool>> filterExpression = record =>
        ...
        var records = await repository.ListAsync(
            query =>
            {
                ...
                {
                    q = (System.Linq.IOrderedQueryable<LS.Domain.Features.Shared.Payments.Entities.PaymentRecord>)q.Where(record => 
