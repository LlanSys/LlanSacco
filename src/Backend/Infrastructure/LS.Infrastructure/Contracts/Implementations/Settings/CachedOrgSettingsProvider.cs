...
namespace LS.Infrastructure.Contracts.Implementations.Settings;

public class CachedOrgSettingsProvider(
    IDistributedCache cache,
    ICurrentTenantProvider tenantProvider,
    IServiceScopeFactory scopeFactory,
    IConfiguration configuration,
    IEncryptionService encryptionService,
    ILogger<CachedOrgSettingsProvider> logger) : IOrgSettingsProvider
{
    ...
    private readonly ILogger<CachedOrgSettingsProvider> _logger = logger;
