...
public class ActivateTenantCommandHandler(
    ...
    ICurrentActorProvider actorProvider) : IRequestHandler<ActivateTenantCommand, AppResponse<TenantResponse>>
{
    private readonly IControlPlaneUnitOfWork _unitOfWork = unitOfWork;
    private readonly ILogger<ActivateTenantCommandHandler> _logger = logger;
