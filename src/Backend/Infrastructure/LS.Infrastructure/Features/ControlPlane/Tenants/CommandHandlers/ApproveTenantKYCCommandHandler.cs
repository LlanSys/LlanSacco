...
using LS.Application.Features.ControlPlane.Tenants.Contracts;
...
public class ApproveTenantKYCCommandHandler(
    IControlPlaneUnitOfWork unitOfWork,
    ILogger<ApproveTenantKYCCommandHandler> logger,
    IStampProvisioner stampProvisioner,
    ICurrentActorProvider actorProvider) : IRequestHandler<ApproveTenantKYCCommand, AppResponse<TenantResponse>>
{
    private readonly IControlPlaneUnitOfWork _unitOfWork = unitOfWork;
    private readonly ILogger<ApproveTenantKYCCommandHandler> _logger = logger;
    private readonly IStampProvisioner _stampProvisioner = stampProvisioner;
