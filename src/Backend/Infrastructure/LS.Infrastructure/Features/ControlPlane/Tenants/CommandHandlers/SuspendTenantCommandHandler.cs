...
public class SuspendTenantCommandHandler(
    ...
    ICurrentActorProvider actorProvider) : IRequestHandler<SuspendTenantCommand, AppResponse<TenantResponse>>
{
    private readonly IControlPlaneUnitOfWork _unitOfWork = unitOfWork;
    private readonly ILogger<SuspendTenantCommandHandler> _logger = logger;
