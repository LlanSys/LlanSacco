...
public class LoanDisbursedIntegrationEventHandler(
    ...
    ILogger<LoanDisbursedIntegrationEventHandler> logger, BackgroundExecutionContext executionContext)
    : AccountingEventHandlerBase<LoanDisbursedIntegrationEvent>(unitOfWork, ledgerService, logger, executionContext)
{
