...
namespace LS.Persistence.Common.DesignTime;
...
internal static class DesignTimeConfigurationFactory
{
    ...
    public static IConfigurationRoot Create()
    {
        return new ConfigurationBuilder()
            ...
            .AddJsonFile(@"src\Backend\Api\LS.Api\appsettings.json", optional: true)
            .AddJsonFile(@"src\Backend\Api\LS.Api\appsettings.Development.json", optional: true)
