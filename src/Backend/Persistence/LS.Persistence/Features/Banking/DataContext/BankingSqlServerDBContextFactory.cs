...
public class BankingSqlServerDBContextFactory : IDesignTimeDbContextFactory<BankingSqlServerDBContext>
{
    public BankingSqlServerDBContext CreateDbContext(string[] args)
    {
        ...
        optionsBuilder.UseSqlServer(
            connectionString,
            sqlOptions => DesignTimeConfigurationFactory.ConfigureSqlServer(sqlOptions, "__EFMigrationsHistory_Banking")).ReplaceService<Microsoft.EntityFrameworkCore.Migrations.IMigrationsSqlGenerator, LS.Persistence.Features.Shared.Migrations.Generators.IdempotentSqlServerMigrationsSqlGenerator>();
