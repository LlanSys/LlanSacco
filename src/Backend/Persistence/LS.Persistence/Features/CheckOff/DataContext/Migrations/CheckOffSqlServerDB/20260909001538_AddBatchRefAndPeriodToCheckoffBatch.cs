...
namespace LS.Persistence.Features.CheckOff.DataContext.Migrations.CheckOffSqlServerDB
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CheckoffStagingRowId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CheckoffStagingLoanAllocations_CheckoffStagingRows_CheckoffStagingRowId",
