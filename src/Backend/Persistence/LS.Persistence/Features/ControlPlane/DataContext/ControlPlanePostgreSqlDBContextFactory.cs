...
public class ControlPlanePostgreSqlDBContextFactory : IDesignTimeDbContextFactory<ControlPlanePostgreSqlDBContext>
{
    public ControlPlanePostgreSqlDBContext CreateDbContext(string[] args)
    {
        ...
        optionsBuilder.UseNpgsql(
            connectionString,
            pgOptions => DesignTimeConfigurationFactory.ConfigurePostgreSql(pgOptions, "__EFMigrationsHistory_ControlPlane")).ReplaceService<Microsoft.EntityFrameworkCore.Migrations.IMigrationsSqlGenerator, LS.Persistence.Features.Shared.Migrations.Generators.IdempotentNpgsqlMigrationsSqlGenerator>();
