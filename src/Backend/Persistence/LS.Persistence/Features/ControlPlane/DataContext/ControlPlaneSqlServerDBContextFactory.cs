...
public class ControlPlaneSqlServerDBContextFactory : IDesignTimeDbContextFactory<ControlPlaneSqlServerDBContext>
{
    public ControlPlaneSqlServerDBContext CreateDbContext(string[] args)
    {
        ...
        optionsBuilder.UseSqlServer(
            connectionString,
            sqlOptions => DesignTimeConfigurationFactory.ConfigureSqlServer(sqlOptions, "__EFMigrationsHistory_ControlPlane")).ReplaceService<Microsoft.EntityFrameworkCore.Migrations.IMigrationsSqlGenerator, LS.Persistence.Features.Shared.Migrations.Generators.IdempotentSqlServerMigrationsSqlGenerator>();
