...
namespace LS.Persistence.Features.ControlPlane.DataContext.Migrations.ControlPlanePostgreSqlDB
{
    ...
    [Migration("20260906170900_CleanMenuSeedData")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LS.Domain.Features.ControlPlane.Auditing.Entities.ImpersonationRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("LS.Domain.Features.ControlPlane.Tenants.Entities.DeploymentStamp", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("LS.Domain.Features.ControlPlane.Tenants.Entities.Tenant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("LS.Domain.Features.ControlPlane.Tenants.Entities.TenantModule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("LS.Domain.Features.ControlPlane.Tenants.Entities.Tenant", b =>
                {
                    b.HasOne("LS.Domain.Features.ControlPlane.Tenants.Entities.DeploymentStamp", "DeploymentStamp")
                        .WithMany()
            ...
            modelBuilder.Entity("LS.Domain.Features.ControlPlane.Tenants.Entities.TenantModule", b =>
                {
                    b.HasOne("LS.Domain.Features.ControlPlane.Tenants.Entities.Tenant", "Tenant")
                        .WithMany("Modules")
