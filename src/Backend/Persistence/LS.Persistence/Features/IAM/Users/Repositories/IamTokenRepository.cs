...
internal sealed class IamTokenRepository(IamDBContext context) : Repository<RefreshToken>(context), ITokenRepository
{
    private readonly IamDBContext _iamContext = context ?? throw new ArgumentNullException(nameof(context));
