...
public class SharedSqlServerDBContextFactory : IDesignTimeDbContextFactory<SharedSqlServerDBContext>
{
    public SharedSqlServerDBContext CreateDbContext(string[] args)
    {
        ...
        optionsBuilder.UseSqlServer(
            connectionString,
            sqlOptions => DesignTimeConfigurationFactory.ConfigureSqlServer(sqlOptions, "__EFMigrationsHistory_Shared")).ReplaceService<Microsoft.EntityFrameworkCore.Migrations.IMigrationsSqlGenerator, LS.Persistence.Features.Shared.Migrations.Generators.IdempotentSqlServerMigrationsSqlGenerator>();
