...
namespace LS.Persistence.Features.Shared.OrgSettings.EntityConfigurations;

internal sealed class OrgSettingConfiguration : IEntityTypeConfiguration<OrgSetting>
{
