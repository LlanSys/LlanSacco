...
{
    private const string DomainNamespace = "LS.Domain";
    private const string ApplicationNamespace = "LS.Application";
    private const string PersistenceNamespace = "LS.Persistence";
    private const string SharedNamespace = "LS.Shared";
