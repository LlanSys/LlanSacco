...
public sealed class RabbitMqOutboxTransportTests
{
    ...
    public async Task Ef_outbox_should_deliver_message_to_real_rabbitmq_consumer()
    {
        ...
        builder.Services.AddSingleton<LS.Domain.Shared.Contracts.Common.ICurrentTenantProvider, TestTenantProvider>();
        builder.Services.AddSingleton<LS.Domain.Shared.Contracts.Common.ICurrentActorProvider, TestActorProvider>();
...
internal sealed class TestTenantProvider : LS.Domain.Shared.Contracts.Common.ICurrentTenantProvider
{
    public Guid TenantId => Guid.Empty;
}

internal sealed class TestActorProvider : LS.Domain.Shared.Contracts.Common.ICurrentActorProvider
{
