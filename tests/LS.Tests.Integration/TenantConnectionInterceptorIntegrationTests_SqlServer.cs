...
public class TenantConnectionInterceptorIntegrationTests_SqlServer(MsSqlDbFixture fixture) : TenantConnectionInterceptorIntegrationTests<MsSqlDbFixture>(fixture)
{
}
