...
using LS.Persistence.Features.ControlPlane;
using LS.Persistence.Features.ControlPlane.DataContext;
using LS.Persistence.Features.ControlPlane.Tenants.Repositories;
...
public class TenantConnectionResolverIntegrationTests
{
    ...
    public async Task RealResolver_SuccessfullyFetchesDecryptsAndSwapsConnection()
    {
        ...
        var impersonationMock = NSubstitute.Substitute.For<LS.Domain.Features.ControlPlane.Auditing.Contracts.Repositories.IImpersonationRecordRepository>();
